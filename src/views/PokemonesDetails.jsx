...
import './PokemonesDetails.css'; 

export default function PokemonesDetails() {
          ...
          <div className="row g-0">
            <div className=" col-12 col-md-8 d-flex align-content-center">
              {pokemon.sprites.other.dream_world.front_default
                ...
                :
                <svg className="bd-placeholder-img card-img-top" width="70%" height="100" xmlns="http://www.w3.org/2000/svg" role="img" preserveAspectRatio="xMidYMid slice" focusable="false">
                  <title>Placeholder</title>
                  <rect width="80%" height="100%" fill="#868e96"></rect>
